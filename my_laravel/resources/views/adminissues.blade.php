...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="/admindashboard">OAS</a>
        </div>
        <ul class="nav navbar-nav">
            <li><a href="/pending" class="active">Pending Issues</a></li>
...
<!--            --><?php //echo "<pre>"; print_r($data); die;  ?>
            ...
            <textarea class="form-control" rows="12" style="resize: none" name="desc" id="desc" disabled>{{$data['desc']}}</textarea><br>
